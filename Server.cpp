...
static void play_thumbnail(gchar *uri,CustomData *data){
	...
	g_object_set(G_OBJECT(data->filesrc1), "location", "/home/ee212801/SME_Project/thumbnail.jpg", NULL);
	...
	g_object_set(G_OBJECT(data->udpsink2), "host", "10.1.137.205", "port",6666, NULL);
...
int thumbnail(string uri) {
	...
	g_object_set(capsfilter, "caps", gst_caps_new_simple("video/x-raw","framerate",GST_TYPE_FRACTION,1,100, "width", G_TYPE_INT, 250, "height", G_TYPE_INT, 300, NULL), NULL);

	/* Set file sink location */
	g_object_set(G_OBJECT(filesink), "location", "/home/ee212801/SME_Project/thumbnail.jpg", NULL);
...
int main(int argc, char *argv[])
{
	...
	string path = "/home/ee212801/SME_Project/video/"; // Replace with the actual path to your directory
	...
	for (auto i : videos) {
		...
		g_object_set(G_OBJECT(data.udpsink), "host", "10.1.137.205", "port",5680, NULL);
		g_object_set(G_OBJECT(data.udpsink1), "host", "10.1.137.205", "port",5681, NULL);
